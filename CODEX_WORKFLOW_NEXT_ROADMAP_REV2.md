...
**Revision:** **2.0**
**Date:** 2026-09-06
**Master:** `CODEX_WORKFLOW_NEXT_MASTER_PLAN_REV4.md`
**Current executable plan:** `docs/plans/PH-01-plugin-foundation.md`
...
<a id="str-05"></a>
## [STR-05] Documentation
Repo truth; ADR only for durable decisions.
...
- foundational Skills have distinct triggers;
...
- explicit fresh bounded Builder;
...
- direct/delegate decision table;
- runtime TaskEnvelope + RolePayload + TaskDelta;
- semantic profiles;
- Builder/Investigator flows;
- evidence-guided retry;
...
- deterministic post-run scope validator;
...
Guard: semantic profiles + compatibility refresh.

<a id="rmrisk-14"></a>
## [RMRISK-14] Old docs/amendments conflict
Guard: Rev 4 Master + Rev 2 Roadmap are normative replacements.
